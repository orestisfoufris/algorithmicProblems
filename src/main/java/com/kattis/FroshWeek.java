...
public class FroshWeek {
    ...
    public static void main(String[] args) {
        ...
        int T = in.readInt();
        long[] students = new long[T];
        for (int i = 0; i < T; ++i) {
            students[i] = in.readInt();
        }

        out.print(mergeSort(students, 0, students.length - 1));
        out.close();
    }
    ...
    public static long mergeSort(long[] array, int start, int end) {
        ...
        return mergeSort(array, 0, mid) + mergeSort(array, mid + 1, end) + merge(array, start, mid, end);
    }

    public static long merge(long[] array, int start, int mid, int end) {
