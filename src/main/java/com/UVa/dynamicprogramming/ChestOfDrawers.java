...
/**
 * https://uva.onlinejudge.org/external/114/11420.pdf
 */
public class ChestOfDrawers {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // number of ways to have i drawers with
            // j secure and the top drawer unlocked if k = 0, or locked if k = 1
