...
/**
 * Google Code Jam 2015 Standing Ovation problem
 */
public class StandingOvation {

    public int findMin(String file) throws Exception{
        ...
        while(iterations > 0) {
            int maxSi = in.readInt();
            String[] numbers = in.readString().split("(?!^)");
    ...
    public static void main(String[] args) throws Exception{
        ...
        so.findMin("/Users/foufriso/Downloads/A-large.in");
    }
}
